...
class TestNormalizeFilepath:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "path%2Fwith%2Fslashes/file%2Bwith%2Bplus.ipynb",
                "path/with/slashes/file+with+plus.ipynb",
            ),
            ...
            (
                "very/deeply/nested/path/structure/with/many/levels/file.ipynb",
                "very/deeply/nested/path/structure/with/many/levels/file.ipynb",
            ),
        ],
    )
    ...
    def test_fallback_to_cwd_when_serverapp_fails(self):
        ...
        with patch(
            "jupyter_ai_tools.utils.get_serverapp", side_effect=Exception("ServerApp error")
        ):
            result = normalize_filepath(test_path)
